...
import { services, solutionsContent } from '../../constants/content';
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[#7F8C8D] mb-3">{service.description}</p>
                  <button className="flex items-center gap-1 text-[#87CEEB] font-medium group-hover:gap-2 transition-all">
                    <span>자세히 보기</span>
